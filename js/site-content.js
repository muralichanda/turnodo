const SITE_CONTENT = {
  name: 'Murali Krishna Chanda',
  title: 'Principal Engineer & Lead Developer',
...
SITE_CONTENT.terminal.contact = `Get in Touch:
  Email    : ${SITE_CONTENT.email}
  LinkedIn : ${SITE_CONTENT.linkedin}
  X        : ${SITE_CONTENT.twitter}
  GitHub   : ${SITE_CONTENT.github}
  Location : ${SITE_CONTENT.location}`;
